// src/app/signup/password/reset/page.tsx
"use client";
  ...
  return (
    <div className="flex flex-col justify-between w-full h-full px-6 pt-6 pb-5">
      ...
      <div>
        ...
        <p className="text-[16px] font-medium text-[#9E9FAD] mb-8" style={{ fontFamily: "Pretendard" }}>
          새로운 비밀번호를 설정해주세요.
        </p>

        {/* 비밀번호 입력 */}
        <div className="mb-[24px]">
          <label className="block text-[16px] font-bold text-black mb-2">비밀번호</label>
          <div className="relative">
            ...
            />
            <button type="button" onClick={togglePassword} className="absolute right-4 top-1/2 -translate-y-1/2">
              <Image
        ...
        <div className="mb-[49px]">
          ...
          <div className="relative">
            <input
              ...
              className="w-full h-[58px] px-4 pr-10 rounded-[8px] bg-[#F3F4F6] text-[#1A1B1E] text-[16px] font-medium font-[Pretendard] placeholder-[#9E9FAD] focus:outline-none"
            />
            <button type="button" onClick={toggleConfirm} className="absolute right-4 top-1/2 -translate-y-1/2">
              <Image
      ...
      <div className="w-full">
        <PrimaryButton
          ...
          disabled={!isValid}
          onClick={() => {
            router.push("/signup/success?from=password");
          }}
        />
      </div>
    </div>
