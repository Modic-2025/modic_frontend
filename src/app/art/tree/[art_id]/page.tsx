...
const FAKE_TREE_DATA: TypeTreeItem[] = [
  ...
  },
  {
    ...
    parentPostId: 3,
    representativeImageUrl:
      "http://localhost:3000/_next/image?url=https%3A%2F%2Fcdn.modic.kr%2Fgenerated-images%2F0d03053f8ba5460da01d495f7c832e05.png%3FExpires%3D1761464933%26Signature%3DIsrH-wEqz~qlydo71t7kHr51KBSmwBLcFPN13VN1xcuDShXQciycOT6wN3X0IvN5LbAGdZpF4TvfaEza63cdqUV1eIeCt1FeAl06WDSZacaPiqmxttpvE0voAg7JvNR22SpGebX6jktyhZxd3dEbvvO2l6Wo9~wHYtLlVjdN~F-W2pZ4kabhji9KR2l4moc9xwgv7z6xcP8RpAuBvusp2Y5AA9VxoEGvYq~E-tZqMHpifMe4PlzmIz44gxMVBRCsUpwfMuyLzvJQnJcqWWU6UOLGMdQrVIR6me2NUXHs4agBFe7wcmPY9iKfrxkiEWlfcrkJq6LUEDvOE1DHwNd4SQ__%26Key-Pair-Id%3DK1QZP3Y49SA1WG&w=1920&q=75",
  ...
  },
  {
    ...
    parentPostId: 5,
    representativeImageUrl:
      "http://localhost:3000/_next/image?url=https%3A%2F%2Fcdn.modic.kr%2Fgenerated-images%2Ff191601f891a493ca0454c028149eb4e.png%3FExpires%3D1761464933%26Signature%3DRCcQpNMcbVsxA4ipLOtlJRoQQTHHScfE425K30jHUpZykfzoewjOdmSYGLB-dh7HXoqdtZKuDm2GqB8XqE7uvYZPgb~6v9S2L0jF3q-BQPs4BPGZFU7dMeGc-ZIDIFI2KTX3~2Jj8ySqMRY7sydMzfbAWh5vo7GhsHp-wmJJcepynFWmdiA-YQ2p50dbTsnBx0zg~9eV0DtgzmdaUoeV-7zBhFovqMDvKmYcnkiU8bqkvBQkUCOzgemDkq7PuWDhwXAt8kprIISgDKgARW0gvpo2OWna4j41S-efE6pAvJ5MGPRqGibngGmrm7Bzd-nZl92gTJCCDONCkxq5OHRO~Q__%26Key-Pair-Id%3DK1QZP3Y49SA1WG&w=1920&q=75",
    postStatus: "DERIVED_PENDING",
  },
];
...
const TreePage = async ({ params }: { params: TreeProp }) => {
  ...
  return <TreeContent data={FAKE_TREE_DATA} />;
};
